...
copyright = '2020, Jose Nicolas Mora'
...
htmlhelp_basename = 'pricing-servicedoc'
...
latex_documents: List = [
    (master_doc, 'pricing-service.tex', 'pricing-service Documentation',
     'Jose Nicolas Mora', 'manual'),
]
